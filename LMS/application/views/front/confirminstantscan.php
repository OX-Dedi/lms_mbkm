            ...
            <div class="card shadow-lg border-0 rounded-lg">
                ...
                <div class="card-body">
                    ...
                    <dl class="row">
                        ...
                        <dt class="col-sm-5">Jenis Kelas:</dt>
                        <dd class="col-sm-7"><?= ($cfmabs['bagian_shift'] == 1) ? '<span class="badge badge-success">Reguler Pagi</span>' : (($cfmabs['bagian_shift'] == 2) ? '<span class="badge badge-warning">Reguler Malam</span>' : '<span class="badge badge-primary">Karyawan</span>'); ?></dd>
                    </dl>
                    <hr>
                    <?= form_dropdown('ket_absen', ['Belajar di Sekolah' => 'Belajar di Sekolah', 'Belajar dari Rumah' => 'Belajar dari Rumah', 'Sakit' => 'Sakit', 'Cuti' => 'Cuti'], '', ['class' => 'form-control align-content-center my-2', 'id' => 'ket_absen']); ?>
