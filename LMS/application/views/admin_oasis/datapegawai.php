<div class="container-fluid">
    <h1 class="my-4"><span class="fas fa-user-tie mr-2"></span>Data Mahasiswa</h1>
    <div class="card mb-4">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title text-center " id="addpegawaimodallabel"><span class="fas fa-user-plus mr-1"></span>Tambah Pengguna</h5>
            </div>
            <div class="modal-body">
                <?= form_open_multipart('#', ['id' => 'addpegawai']) ?>
                <div class="form-group row">
                    <label for="nama_pegawai" class="col-sm-4 col-form-label">Nama Mahasiswa</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_pegawai" name="nama_pegawai">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="username_pegawai" class="col-sm-4 col-form-label">Username Mahasiswa</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="username_pegawai" name="username_pegawai">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="password_pegawai" class="col-sm-4 col-form-label">Password Mahasiswa</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="jabatan_pegawai" class="col-sm-4 col-form-label">NIM/NIP</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="npwp_pegawai" class="col-sm-4 col-form-label">Tahun Masuk</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <?= form_dropdown('role_pegawai', ['' => 'Select Role', 1 => 'Administrator', 2 => 'Guru', 3 => 'Mahasiswa'], set_value('role_pegawai'), 'class="form-control" id="role_pegawai"'); ?>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="shift_pegawai" class="col-sm-4 col-form-label">Jenis Mahasiswa</label>
                    <div class="col-sm-8">
                        <div class="form-check form-check-inline">
                            <?= form_radio('shift_pegawai', 1, set_radio('shift_pegawai[]', 1), "id='shift_pegawai' class='form-check-input'"); ?>
                            <label class="form-check-label" for="shift_pegawai1">Reguler Pagi</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <?= form_radio('shift_pegawai', 2, set_radio('shift_pegawai[]', 2), "class='form-check-input'"); ?>
                            <label class="form-check-label" for="shift_pegawai2">Reguler Malam </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <?= form_radio('shift_pegawai', 3, set_radio('shift_pegawai[]', 3), "class='form-check-input'"); ?>
                            <label class="form-check-label" for="shift_pegawai3">Karyawan</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="verifikasi_pegawai" class="col-sm-4 col-form-label">Verifikasi Mahasiswa</label>
                    <div class="col-sm-8">
                        <div class="form-check form-check-inline">
                ...
                <div class="form-group row">
                    <label for="barcode_pegawai" class="col-sm-4 col-form-label">Buat Barcode Mahasiswa</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">Pas Foto Mahasiswa</div>
                    <div class="col-sm-8">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="viewpegawaimodallabel"><span class="fas fa-user-tie mr-1"></span>Preview Mahasiswa</h5>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="editpegawaimodal" tabindex="-1" role="dialog" aria-labelledby="editpegawaimodal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="editpegawaimodallabel"><span class="fas fa-user-edit mr-1"></span>Edit Mahasiswa</h5>
            </div>
            <div class="modal-body">
