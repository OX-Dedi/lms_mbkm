...
<script>
    ...
    const abiChart = (chartType) => {
        $.ajax({
        url: baseUrl+'Customers/chart_data',
        dataType: 'json',
        method: 'get',
        success: data=>{
            let chartX = []
        ...
        success: data=>{
            ...
            data.map( data =>{
                chartX.push(data.faculty_id)
                chartY.push(data.total_activity)
            })
