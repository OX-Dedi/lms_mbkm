<div class="row detail">
    ...
    <div class="col-md-10 col-sm-8 col-6">
        <dl class="row">
            ...
            <dd class="col-sm-7"><?= $shiftpegawai = ($datapegawai['bagian_shift'] == 1) ? '<span class="badge badge-success">Reguler Pagi</span>' : (($datapegawai['bagian_shift'] == 2) ? '<span class="badge badge-warning">Reguler Malam</span>' : '<span class="badge badge-primary">Karyawan</span>'); ?></dd>
        </dl>
    </div>
</div>
<div class="text-center">
    <h4 class="my-2">Barcode Account</h4>
