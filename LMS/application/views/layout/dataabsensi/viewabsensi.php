...
<?php if ($dataapp['maps_use'] == 1) : ?>
    ...
    <?php if (!empty($dataabsensi['maps_absen']) && $dataabsensi['maps_absen'] != 'No Location') : ?>
        ...
        <a class="btn btn-primary my-2" href="https://goo.gl/maps/9bY1MLoTVbK1Eq8s5<?= $dataabsensi['maps_absen']; ?>" target="_blank"><span class="fas fa-fw fa-map-marker-alt mr-1"></span>Lihat Lokasi</a>
        <script>
